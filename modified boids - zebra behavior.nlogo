...
to setup
  ...
  create-turtles population
    [ set color yellow - 2 + random 7  ;; random shades look nice
      ...
      set energy 100 ;; initialize energy level
      set ate-food? false
    ]
  ;; patches being generated
  let generated 0
  while [generated <  10 + (random (20 - 10))][
    generate-food
...
to go
  ...
  ask patches with [pcolor = brown] [
    set ticks-since-food-eaten ticks-since-food-eaten + 1
    if ticks-since-food-eaten = 20 [ ;; 20 - num of ticks before patch regeneration
      set pcolor green
      set ticks-since-food-eaten 0
    ]
  ]
...
to reproduce
  let reproduction-probability 0.02 ;; 2% chance of reproducing
...
to create-offspring
  hatch 1[
    ...
    ;;setxy [xcor] of myself [ycor] of myself ;;spawn the the agent on the parent
    setxy random-xcor random-ycor ;;spawn the agent randomly
    set energy 50
  ]
end

;;-------------------end created funcs for zebra-------------------
